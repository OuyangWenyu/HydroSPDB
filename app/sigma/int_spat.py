...
trainName = 'CONUSv2f1'
testNameLst = ['CONUSv2f1', 'CONUSv2fx2', 'CONUSv2fy2']
out = trainName+'_y15_Forcing'
yr = [2015]
caseStrLst = ['CONUSv2f1', 'CONUSv2fx2', 'CONUSv2fy2']
