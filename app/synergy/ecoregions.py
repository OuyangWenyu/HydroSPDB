...
# python ecoRegion.py --cfg ecoregion/config_exp17.ini --ctx 1 --rs 12345 --te 300 --train_mode True
...
# python ecoRegion.py --cfg ecoregion/config_exp20.ini --ctx 1 --rs 11111 --te 300 --train_mode True
