...
optTrain = data_config.update(data_config.optTrainSMAP, miniBatch=[30, 60], nEpoch=500)
out = os.path.join(cDir, 'output_VIC/CONUS_v16f1_SOILM_lev1_rho60_pix30_ep500')
