...
optTrain = read_config.update(read_config.optTrainSMAP, miniBatch=[100, 15], nEpoch=500)
out = os.path.join(cDir, 'output_VIC/CONUS_v16f1_SSRUN_rho15_ep500_tr16_te1')
