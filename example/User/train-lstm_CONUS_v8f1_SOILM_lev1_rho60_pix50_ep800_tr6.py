...
optTrain = read_config.update(read_config.optTrainSMAP, miniBatch=[50, 60], nEpoch=800)
out = os.path.join(cDir, 'output_VIC/CONUS_v8f1_SOILM_lev1_rho60_pix50_ep800_tr6')
