...
optData = read_config.update(
    ...
    varC=[
    'DEPTH_2', 'DEPTH_3', 'Ds', 'Ds_MAX', 'EXPT_1', 'EXPT_2', 'EXPT_3',
    'INFILT', 'Ws'
],
...
optTrain = read_config.update(read_config.optTrainSMAP, miniBatch=[100, 60], nEpoch=500)
out = os.path.join(cDir, 'output_VIC/CONUS_v16f1_SOILM_lev1_rho60_ep500_tr6_rm_Depth1')
