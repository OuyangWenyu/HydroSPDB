...
optData = data_config.update(
    ...
    'INFILT', 'Ws', 'Ksat_1', 'Ksat_2', 'Ksat_3', 'MOIST_1', 'MOIST_2', 'MOIST_3'
],
...
optTrain = data_config.update(data_config.optTrainSMAP, miniBatch=[100, 90], nEpoch=300)
out = os.path.join(cDir, 'output_VIC/CONUS_v16f1_SOILM_lev1_rho90_Ksat_MOIST')
