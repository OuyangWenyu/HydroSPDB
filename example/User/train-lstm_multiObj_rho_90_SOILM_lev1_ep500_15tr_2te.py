...
optTrain = read_config.update(read_config.optTrainSMAP, miniBatch=[100, 90], nEpoch=500)
out = os.path.join(cDir, 'output_VIC/CONUS_v16f1_SOILM_lev1_rho90_ep500_15tr_2te')
