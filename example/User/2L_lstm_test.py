from data import dbCsv, data_config
...
optData_2L = default.update(
    default.optDataSMAP_2L, # need to modify 'master/data_config.py & master.py', 'data/dbCsv.py'
...
optTrain = data_config.update(data_config.optTrainSMAP, miniBatch=[100, 60], nEpoch=1)
...
model_2L = train.model_train(
    model_2L, x_2L, y_2L, C2, lossFun_2L, nEpoch=epoch)
modelName = 'test-2L'
train.model_save(outFolder, model_2L, epoch, modelName=modelName)
