...
optData = data_config.update(
    ...
    'VGRD_10_FORA', 'UGRD_10_FORA', 'PEVAP_FORA', 'PRES_FORA','LSOIL_0-10_NOAH','SOILM_0-10_NOAH'
],
    varC=[
...
optTrain = data_config.update(data_config.optTrainSMAP, miniBatch=[50, 60], nEpoch=500)
out = os.path.join(cDir, 'output_VIC/CONUS_v16f1_SOILM_lev1_rho60_NOAH_pix50_ep500_tr6')
