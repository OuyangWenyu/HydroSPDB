...
optTrain = data_config.update(data_config.optTrainSMAP, miniBatch=[100, 60], nEpoch=300)
out = os.path.join(cDir, 'output_VIC/CONUS_v16f1_SOILM_lev1_rho60_NOAH_tr6')
