...
optTrain = data_config.update(data_config.optTrainSMAP, miniBatch=[100, 60], nEpoch=800)
out = os.path.join(cDir, 'output_VIC/CONUS_v8f1_SOILM_lev1_rho60_ep800_tr6')
