...
optTrain = data_config.update(data_config.optTrainSMAP, miniBatch=[50, 60], nEpoch=500, saveEpoch=100)
out = os.path.join(cDir, 'multiOutput_CONUSv16f1_VIC/CONUS_v8f1_SSRUN_EVP_SOILM_lev1_tr6_pix50')
