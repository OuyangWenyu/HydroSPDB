...
filename = '/mnt/sdc/SUR_VIC/multiOutput_CONUSv16f1_VIC/CONUS_v16f1_SOILM_lev1_PF_LSTM_Para6/PF_LSTM_Ep500.pt'
# model_PF_loaded = torch.load(filename)
# model_PF_loaded.eval()
# train.testModel(model_PF_loaded, Forcing_tensor, Parameters_tensor)

path_R2PF = 'multiOutput_CONUSv16f1_VIC/CONUS_v16f1_SOILM_lev1_R2PF_LSTM_Para6'
