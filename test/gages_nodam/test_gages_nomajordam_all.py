...
class MyTestCase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        # self.config_file = os.path.join(config_dir, "nodam/config_exp2.ini")
        # self.subdir = r"nodam/exp2"
        self.config_file = os.path.join(config_dir, "nodam/config_exp3.ini")
        self.subdir = r"nodam/exp3"
