...
from data.gages_input_dataset import GagesDamDataModel, choose_which_purpose, load_dataconfig_case_exp, GagesModels
    ...
    def test_dam_test(self):
        with torch.cuda.device(0):
            gages_input = GagesModel.load_datamodel(self.config_data.data_path["Temp"],
                                                    ...
                                                    var_dict_file_name='test_dictAttribute.json',
                                                    t_s_dict_file_name='test_dictTimeSpace.json')
            pred, obs = master_test(gages_input, epoch=cfg.MODEL.TEST_EPOCH)
            ...
            save_result(gages_input.data_source.data_config.data_path['Temp'], cfg.MODEL.TEST_EPOCH, pred, obs)
