...
class MyTestCaseGages(unittest.TestCase):
    def setUp(self) -> None:
        ...
        # self.config_file = os.path.join(config_dir, "basic/config_exp32.ini")
        # self.subdir = r"basic/exp32"
        # self.random_seed = 123
        self.config_file = os.path.join(config_dir, "basic/config_exp35.ini")
        self.subdir = r"basic/exp35"
