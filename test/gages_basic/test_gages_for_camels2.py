...
class MyTestCaseGages(unittest.TestCase):
    def setUp(self) -> None:
        ...
        # self.config_file = os.path.join(config_dir, "basic/config_exp33.ini")
        # self.subdir = r"basic/exp33"
        # self.random_seed = 12345
        self.config_file = os.path.join(config_dir, "basic/config_exp36.ini")
        self.subdir = r"basic/exp36"
