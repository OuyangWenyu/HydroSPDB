...
class MyTestCase(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.config_file = os.path.join(config_dir, "gages1by1/config_exp1.ini")
        self.subdir = r"gages1by1/exp1"
    ...
    def test_train_gages_iter(self):
        ...
        with torch.cuda.device(0):
            # data_models = GagesModel.every_model(data_model)  python -m unittest test_gages_1by1.MyTestCase.test_train_gages_iter
            for i in range(788, data_model.data_flow.shape[0]):
