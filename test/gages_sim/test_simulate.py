...
class MyTestCase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.sim_config_file = os.path.join(config_dir, "simulate/config1_exp11.ini")
        self.config_file = os.path.join(config_dir, "simulate/config2_exp11.ini")
        self.subdir = "simulate/exp11"
    ...
    def test_gages_sim_data_model(self):
        ...
        data_model2_test = GagesModel.load_datamodel(data_dir,
                                                     ...
                                                     var_dict_file_name='test_dictAttribute.json',
                                                     t_s_dict_file_name='test_dictTimeSpace.json')
        sim_gages_model_train = GagesModel.update_data_model(self.sim_config_data, data_model1_test,
                                                             t_range_update=self.sim_config_data.model_dict["data"][
                                                                 "tRangeTrain"], data_attr_update=True)
        gages_model_train = GagesModel.update_data_model(self.config_data, data_model2_test,
