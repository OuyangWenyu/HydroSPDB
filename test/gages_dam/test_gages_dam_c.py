...
class MyTestCase(unittest.TestCase):
    ...
    def test_gages_dam_attr(self):
        ...
        save_nidinput(nid_input, self.config_data.data_path["Temp"], nid_source_file_name='nid_source.txt',
        ...
        serialize_json(data_input.gage_main_dam_purpose,
                       os.path.join(self.config_data.data_path["Temp"], "dam_main_purpose_dict.json"))
    ...
    def test_dam_train(self):
        with torch.cuda.device(2):
            df = GagesModel.load_datamodel(self.config_data.data_path["Temp"], data_source_file_name='data_source.txt',
                                           ...
                                           var_dict_file_name='dictAttribute.json',
                                           t_s_dict_file_name='dictTimeSpace.json')
            nid_input = NidModel.load_nidmodel(self.config_data.data_path["Temp"], nid_file=self.nid_file,
