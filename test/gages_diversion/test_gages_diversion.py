...
class MyTestCaseGages(unittest.TestCase):
    def setUp(self) -> None:
        ...
        # self.config_file = os.path.join(config_dir, "diversion/config_exp1.ini")
        # self.subdir = r"diversion/exp1"
        self.config_file = os.path.join(config_dir, "diversion/config_exp2.ini")
        self.subdir = r"diversion/exp2"
    ...
    def test_gages_data_model(self):
        # gages_model = GagesModels(self.config_data, screen_basin_area_huc4=False, diversion=True)
        gages_model = GagesModels(self.config_data, screen_basin_area_huc4=False, diversion=False)
