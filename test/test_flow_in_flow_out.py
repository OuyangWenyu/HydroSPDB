...
class MyTestCase(unittest.TestCase):
    ...
    def test_natural_flow_in_train(self):
        ...
        model_input = SimNatureFlowInput(source_data)
        master_train_natural_flow(model_input)
    ...
    def test_natural_flow_in_test(self):
        """using natural flow generated by model trained by choosed allref basins in CAMELS dataset"""
        source_data = SimNatureFlowSource.get_sim_nature_flow_source(self.config_data,
        ...
        show_me_num = 5
        t_s_dict = model_input.data_source.model_data.t_s_dict
